...
| final-v1.00 | G7-G12 Teaching Subjects Combobox Checklist & Teacher Dashboard Subject Cards | All Admin pages; `views/teacher/dashboard.php`, `views/teacher/student-profiles.php` | grades, reports, settings (teacher); all student |
