...
<head>
  ...
  <style>
    ...
    .portal-card { background:#fff; border-radius:16px; box-shadow:0 8px 32px rgba(0,0,0,.2); padding:2rem 1.5rem; text-align:center; text-decoration:none; color:inherit; transition:.25s; cursor:pointer; }
    ...
    .portal-card .portal-arrow { margin-top:1rem; font-size:.82rem; font-weight:600; color:#1a73e8; }
...
<div class="portal-container">
  ...
  <div class="portal-cards">
    <a href="<?= BASE_URL ?>/views/auth/login.php?role=admin" class="portal-card">
      <div class="portal-icon admin"><i class="fas fa-user-shield"></i></div>
      <h5>Administrator</h5>
      <p>Manage students, reports, accounts, and school analytics</p>
      <div class="portal-arrow">Enter Portal <i class="fas fa-arrow-right ms-1"></i></div>
    </a>

    <a href="<?= BASE_URL ?>/views/auth/login.php?role=teacher" class="portal-card">
      ...
      <div class="portal-arrow" style="color:var(--secondary);">Enter Portal <i class="fas fa-arrow-right ms-1"></i></div>
    </a>

    <a href="<?= BASE_URL ?>/views/auth/login.php?role=student" class="portal-card">
      <div class="portal-icon student"><i class="fas fa-user-graduate"></i></div>
      <h5>Student</h5>
      <p>View your profile, grades, and school announcements</p>
      <div class="portal-arrow" style="color:#f59e0b;">Enter Portal <i class="fas fa-arrow-right ms-1"></i></div>
    </a>
  </div>
